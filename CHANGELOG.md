...
- skip detect-confirmed-absent banks in refresh() (#268 slice 5) (#347) ([282a95e](https://github.com/dewet22/givenergy-modbus/commit/282a95efa38427c99abeb9cc4afc79cd7e9c5dba))

## [2.9.1] - 2026-06-29

### ✨ Added

- generalise refresh skip-if-fresh to all banks via max_age (#268 slice 4) (#346) ([69a4feb](https://github.com/dewet22/givenergy-modbus/commit/69a4febca979629104bf551d1a6eb4bf8f228374))
...
- re-enumerate a cold-start-held LV battery in detect() (hass#233) (#334) ([6fcb906](https://github.com/dewet22/givenergy-modbus/commit/6fcb906f48b9eab7dd469da5950155a550734c47))
...
- add e_pv_direct_today computed field (#313) ([d31a0d1](https://github.com/dewet22/givenergy-modbus/commit/d31a0d1406ca6a4bd544adc80fc086b12b601cf3))
...
- widen cell_mV/v_out thresholds for the near-full-SOC knee (#299) (#300) ([67096d3](https://github.com/dewet22/givenergy-modbus/commit/67096d361bcac445b510c5f3d1bfbd0f11915a16))

## [2.5.6] - 2026-06-24

### ✨ Added

- enable battery_*_limit_ac (HR313/314) writes for single-phase AC (#295) (#296) ([3496d19](https://github.com/dewet22/givenergy-modbus/commit/3496d194698dae3e22d1f1b89c8b04c5f4dca8c8))

### 🐛 Fixed

- disambiguate serials in main() + deprecate `python -m` serve path (#292) ([649207c](https://github.com/dewet22/givenergy-modbus/commit/649207cf0dd80ae615778cade5cf6114852c2366))
...
- de-noise #256 splice-guard singleton path (thresholds + logging) ([e116b65](https://github.com/dewet22/givenergy-modbus/commit/e116b6571c989691edb10f3aaa75eae548f78774))
