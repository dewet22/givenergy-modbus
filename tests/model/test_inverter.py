...
from .test_register_cache import register_cache_inverter_daytime_discharging_with_solar_generation  # noqa: F401
...
def test_from_orm_actual_data(register_cache_inverter_daytime_discharging_with_solar_generation):  # noqa: F811
    ...
    assert i.dict() == {
        ...
        'e_battery_discharge_day': 3.4000000000000004,
        'e_battery_discharge_day_2': 3.4000000000000004,
        ...
        'e_inverter_in_day': 9.3,
        'e_inverter_in_total': 188.10000000000002,
        'e_inverter_out_day': 3.8000000000000003,
        'e_inverter_out_total': 172.5,
        'e_pv1_day': 0.4,
        'e_pv2_day': 0.6000000000000001,
        'e_solar_diverter': 0.0,
        'enable_60hz_freq_mode': False,
        'enable_ammeter': True,
        'enable_auto_judge_battery_type': True,
        ...
        'temp_battery': 16.0,
        'temp_charger': 24.1,
        'temp_inverter_heatsink': 24.400000000000002,
        'usb_device_inserted': 2,
        'v_ac1': 236.3,
        'v_ac_high_c': 283.7,
        'v_ac_high_in': 262.0,
