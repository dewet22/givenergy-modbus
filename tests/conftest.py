...
_server_messages: PduTestCases = [
    ...
    (
        "2:6/WriteHoldingRegisterRequest(178 -> 2000/0x07d0)",
        WriteHoldingRegisterRequest,
        {
            "register": 178,
            "value": 2000,
        ...
        b"YY\x00\x01\x00\x1c\x01\x02",
        b"AB1234G567\x00\x00\x00\x00\x00\x00\x00\x08\x32\x06\x00\xb2\x07\xd0\x2f\x82",
        InvalidPduState(r"HR\(178\) is not safe to write to", None),
    ),
    (
...
_client_messages: PduTestCases = [
    ...
    (
        ...
        b"\xe4\x63",  # 2b crc (recomputed: response CRC now real, #158)
        None,
    ),
    (
