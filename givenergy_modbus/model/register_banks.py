...
class InputRegister(RegisterBank):
    ...
    TEMP_CELL1 = (76, {'scaling': Scaling.DECI})
    TEMP_CELL2 = (77, {'scaling': Scaling.DECI})
    TEMP_CELL3 = (78, {'scaling': Scaling.DECI})
    TEMP_CELL4 = (79, {'scaling': Scaling.DECI})
    V_BATTERY_SUM = (80, {'scaling': Scaling.MILLI})
    TEMP_MOS = (81, {'scaling': Scaling.DECI})
    V_OUT_H = (82, {'type': Type.DWORD_HIGH, 'scaling': Scaling.MILLI})
    V_OUT_L = (83, {'type': Type.DWORD_LOW, 'scaling': Scaling.MILLI})
    FULL_CAPACITY_H = (84, {'type': Type.DWORD_HIGH, 'scaling': Scaling.CENTI})
    FULL_CAPACITY_L = (85, {'type': Type.DWORD_LOW, 'scaling': Scaling.CENTI})
    DESIGN_CAPACITY_H = (86, {'type': Type.DWORD_HIGH, 'scaling': Scaling.CENTI})
    DESIGN_CAPACITY_L = (87, {'type': Type.DWORD_LOW, 'scaling': Scaling.CENTI})
    REMAINING_CAPACITY_H = (88, {'type': Type.DWORD_HIGH, 'scaling': Scaling.CENTI})
    REMAINING_CAPACITY_L = (89, {'type': Type.DWORD_LOW, 'scaling': Scaling.CENTI})
    STATUS_1_2 = 90
    STATUS_3_4 = 91
    STATUS_5_6 = 92
    STATUS_7 = 93
    ...
    REG099 = 99
    BATTERY_SOC = 100
    DESIGN_CAPACITY_H_1 = (101, {'type': Type.DWORD_HIGH, 'scaling': Scaling.CENTI})
    DESIGN_CAPACITY_L_2 = (102, {'type': Type.DWORD_LOW, 'scaling': Scaling.CENTI})
    REG103 = 103
    REG104 = 104
    ...
    USB_INSERTED = 115 #0X08 = true; 0X00 = false
    REG116 = 116
    REG117 = 117
    REG118 = 118
    REG119 = 119
