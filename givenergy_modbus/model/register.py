...
class InputRegister(Register):
    ...
    E_PV_TOTAL_GENERATING_CAPACITY_H = (11, {'type': Type.UINT32_HIGH, 'scaling': Scaling.DECI, 'unit': Unit.ENERGY_KWH})
    E_PV_TOTAL_GENERATING_CAPACITY_L = (12, {'type': Type.UINT32_LOW, 'scaling': Scaling.DECI, 'unit': Unit.ENERGY_KWH})
