...
class HoldingRegister(RegisterBank):
    ...
    INV_STATE = (53, Type.WORD, Scaling.UNIT)  # 1 = normal?
    BAT_TYPE = (54, Type.WORD, Scaling.UNIT)  # 1 = lithium?
    ...
    AUTO_JUDGE_BAT_TYPE_ENABLE = (58, Type.WORD, Scaling.UNIT)  # bool?
...
class InputRegister(RegisterBank):
    ...
    INV_STATUS = (0, Type.WORD, Scaling.UNIT)  # 0 normal (no PV, no bat)
