...
class BcuRegisterGetter(RegisterGetter):
    ...
    REGISTER_LUT = {
        ...
        "battery_voltage": Def(C.deci, None, IR(73)),
        "load_voltage": Def(C.deci, None, IR(74)),
        "battery_current": Def(C.int16, C.deci, IR(76)),
        "battery_power": Def(C.milli, None, IR(79)),
        "battery_soc_max": Def((C.duint8, 0), None, IR(80)),
        "battery_soc_min": Def((C.duint8, 1), None, IR(80)),
        "battery_soh": Def(C.uint16, None, IR(81)),
