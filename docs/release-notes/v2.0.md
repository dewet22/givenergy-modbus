...
[`givenergy-hass`](https://github.com/dewet22/givenergy-hass) is cutting [its own v1.0 release](https://github.com/dewet22/givenergy-hass/pull/41) alongside the library. It's as much a relaunch of the integration as v2.0 is of the library — the codebase was carrying several years of incremental fixes without a cohesive story, and v1.0 gives it one.
